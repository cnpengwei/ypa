...
<body>
    ...
    <script src="/Public/admin/js/editors/wysiwyg/jquery.hotkeys.js"></script>
    <script src="/Public/admin/js/editors/wysiwyg/prettify.js"></script>
    <script src="/Public/admin/js/editors/wysiwyg/bootstrap-wysiwyg.js"></script>
    <script>
        $(function () {
    ...
    <!--Summernote Scripts-->
    <script src="/Public/admin/js/editors/summernote/summernote.js"></script>
    <script>
