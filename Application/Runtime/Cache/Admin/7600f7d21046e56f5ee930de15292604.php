...
<head>
    ...
    <!--Page Related styles-->
    <link href="/Public/admin/css/dataTables.bootstrap.css" rel="stylesheet" />
...
<body>
    ...
    <script src="/Public/admin/js/datatable/jquery.dataTables.min.js"></script>
    <script src="/Public/admin/js/datatable/ZeroClipboard.js"></script>
    <script src="/Public/admin/js/datatable/dataTables.tableTools.min.js"></script>
    <script src="/Public/admin/js/datatable/dataTables.bootstrap.min.js"></script>
    <script src="/Public/admin/js/datatable/datatables-init.js"></script>
    <script>
