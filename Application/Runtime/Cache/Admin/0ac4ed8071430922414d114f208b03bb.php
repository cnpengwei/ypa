...
<body>
    ...
    <script src="/Public/js/tagsinput/bootstrap-tagsinput.js"></script>

    <!--Bootstrap Date Picker-->
    <script src="/Public/js/datetime/bootstrap-datepicker.js"></script>

    <!--Bootstrap Time Picker-->
    <script src="/Public/js/datetime/bootstrap-timepicker.js"></script>

    <!--Bootstrap Date Range Picker-->
    <script src="/Public/js/datetime/moment.js"></script>
    <script src="/Public/js/datetime/daterangepicker.js"></script>

    <!--Jquery Autosize-->
    <script src="/Public/js/textarea/jquery.autosize.js"></script>

    <!--Fuelux Spinner-->
    <script src="/Public/js/fuelux/spinner/fuelux.spinner.min.js"></script>

    <!--jQUery MiniColors-->
    <script src="/Public/js/colorpicker/jquery.minicolors.js"></script>

    <!--jQUery Knob-->
    <script src="/Public/js/knob/jquery.knob.js"></script>

    <!--noUiSlider-->
    <script src="/Public/js/slider/jquery.nouislider.js"></script>

    <!--jQRangeSlider-->
    <script src="/Public/js/jquery-ui-1.10.4.custom.js"></script>
    <script src="/Public/js/slider/jQRangeSlider/jQAllRangeSliders-withRuler-min.js"></script>
