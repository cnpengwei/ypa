...
<body>
                                    ...
                                    <li>
                                        <a href="#">
                                            ...
                                            <div class="message">
                                                ...
                                                <span class="message-subject">
                                                    Bing Newsletter: The January Issue????                                                </span>
                                                <span class="message-body">
                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-3 col-sm-6 col-xs-12">
                                    <div class="databox databox-graded">
                                        <div class="databox-left no-padding">
                                            <img src="/Public/img/avatars/divyia.jpg" style="width:65px; height:65px;">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-sm-6 col-xs-12">
                                    <div class="databox databox-lg databox-inverted radius-bordered databox-shadowed databox-graded databox-vertical">
                                        <div class="databox-top no-padding">
                                            <img src="/Public/img/temp1.png" alt="" style="height:100px; width:100%;" />
                                        </div>
                                    ...
                                    <div class="databox databox-xlg databox-halved radius-bordered databox-shadowed databox-vertical">
                                        <div class="databox-top bg-white padding-10">
                                            <div class="col-lg-4 col-sm-4 col-xs-4">
                                                <img src="/Public/img/avatars/Sergey-Azovskiy.jpg" style="width:75px; height:75px;" class="image-circular bordered-3 bordered-palegreen" />
                                            </div>
    ...
    <script src="/Public/js/charts/sparkline/jquery.sparkline.js"></script>
    <script src="/Public/js/charts/sparkline/sparkline-init.js"></script>

    <script src="/Public/js/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="/Public/js/charts/easypiechart/easypiechart-init.js"></script>

    <script src="/Public/js/charts/morris/raphael-2.0.2.min.js"></script>
    <script src="/Public/js/charts/morris/morris.js"></script>
    <script src="/Public/js/charts/morris/morris-init.js"></script>

    <script src="/Public/js/charts/flot/jquery.flot.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.orderBars.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.resize.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.selection.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.crosshair.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.stack.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.time.js"></script>
    <script src="/Public/js/charts/flot/jquery.flot.pie.js"></script>

    <script src="/Public/js/charts/chartjs/Chart.js"></script>
    <script>
