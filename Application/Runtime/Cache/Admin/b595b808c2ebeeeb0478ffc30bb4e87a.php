...
<head>
    ...
    <link rel="icon" href="/ypa/Public/admin/img/favicon.png" type="image/png">


    <!--Basic Styles-->
    <link href="/ypa/Public/admin/css/bootstrap.min.css" rel="stylesheet" />
    <link id="bootstrap-rtl-link" href="" rel="stylesheet" />
    <link href="/ypa/Public/admin/css/font-awesome.min.css" rel="stylesheet" />
    <link href="/ypa/Public/admin/css/weather-icons.min.css" rel="stylesheet" />

    <!--Fonts-->
    <link href="http://fonts.useso.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,400,600,700,300" rel="stylesheet" type="text/css">

    <!--Beyond styles-->
    <link id="beyond-link" href="/ypa/Public/admin/css/beyond.min.css" rel="stylesheet" type="text/css" />
    <link href="/ypa/Public/admin/css/demo.min.css" rel="stylesheet" />
    <link href="/ypa/Public/admin/css/typicons.min.css" rel="stylesheet" />
    <link href="/ypa/Public/admin/css/animate.min.css" rel="stylesheet" />
    <link id="skin-link" href="" rel="stylesheet" type="text/css" />

    <!--Skin Script: Place this script in head to load scripts for skins and rtl support-->
    <script src="/ypa/Public/admin/js/skins.min.js"></script>
</head>
<!-- /Head -->
<!-- Body -->
<body>
            ...
            <div class="navbar-container">
                ...
                <div class="navbar-header pull-left">
                    <a href="#" class="navbar-brand">
                        <small>
                            <img src="/ypa/Public/admin/img/logo.png" alt="" />
                        </small>
                    </a>
                </div>
                <!-- /Navbar Barnd -->
                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                    <li>
                                        <a href="#">
                                            <img src="/ypa/Public/admin/img/avatars/divyia.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="/ypa/Public/admin/img/avatars/bing.png" class="message-avatar" alt="Microsoft Bing">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="/ypa/Public/admin/img/avatars/adam-jansen.jpg" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
                            ...
                            <li>
                                <a class="login-area dropdown-toggle" data-toggle="dropdown">
                                    <div class="avatar" title="View your public profile">
                                        <img src="/ypa/Public/admin/img/avatars/adam-jansen.jpg">
                                    </div>
                                    <section>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                    ...
                                    <li>
                                        <div class="avatar-area">
                                            <img src="/ypa/Public/admin/img/avatars/adam-jansen.jpg" class="avatar">
                                    ...
                                    <li class="theme-area">
                                        <ul class="colorpicker" id="skin-changer">
                                            <li><a class="colorpick-btn" href="#" style="background-color:#5DB2FF;" rel="/ypa/Public/admin/css/skins/blue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#2dc3e8;" rel="/ypa/Public/admin/css/skins/azure.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#03B3B2;" rel="/ypa/Public/admin/css/skins/teal.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#53a93f;" rel="/ypa/Public/admin/css/skins/green.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#FF8F32;" rel="/ypa/Public/admin/css/skins/orange.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#cc324b;" rel="/ypa/Public/admin/css/skins/pink.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#AC193D;" rel="/ypa/Public/admin/css/skins/darkred.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#8C0095;" rel="/ypa/Public/admin/css/skins/purple.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#0072C6;" rel="/ypa/Public/admin/css/skins/darkblue.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#585858;" rel="/ypa/Public/admin/css/skins/gray.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#474544;" rel="/ypa/Public/admin/css/skins/black.min.css"></a></li>
                                            <li><a class="colorpick-btn" href="#" style="background-color:#001940;" rel="/ypa/Public/admin/css/skins/deepblue.min.css"></a></li>
                                        </ul>
                                    </li>
                                    <!--/Theme Selector Area-->
                                    <li class="dropdown-footer">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <!-- Concert -->
                    <li>
                        <a href="/Admin/Concert/Concert">
                            <!-- <i class="menu-icon fa fa-building-o"></i> -->
                            <i class="menu-icon fa fa-shopping-cart"></i>
                            <span class="menu-text">项目维护</span>
                        </a>
                    </li>
                    <!--Databoxes-->
                    <li>
                        <a href="/Admin/Index/databoxes">
                            <i class="menu-icon glyphicon glyphicon-tasks"></i>
                            <span class="menu-text"> 中文Data Boxes </span>
                        </a>
                    </li>
                    <!--Widgets-->
                    <li>
                        <a href="/Admin/Index/widgets.html">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="/Admin/Index/elements.html">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="/Admin/Index/form-inputs">
                                    <span class="menu-text">Form Inputs</span>
                                </a>
                            </li>

                            <li>
                                <a href="/Admin/Index/form-pickers">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            ...
                            <li>
                                <a href="/Admin/Index/typography.html">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="/Admin/Index/error-404.html">
                                    <span class="menu-text">Error 404</span>
                                </a>
                            </li>

                            <li>
                                <a href="/Admin/Index/error-500.html">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                    <div class="databox radius-bordered databox-shadowed databox-graded">
                                        <div class="databox-left no-padding bordered-left-2 bordered-palegreen">
                                            <img src="/ypa/Public/admin/img/avatars/John-Smith.jpg" style="width:65px; height:65px;">
                                        </div>
                                                ...
                                                <div class="tickets-container">
                                                    <ul class="tickets-list">
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/ypa/Public/admin/img/avatars/adam-jansen.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/ypa/Public/admin/img/avatars/divyia.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/ypa/Public/admin/img/avatars/Matt-Cheuvront.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/ypa/Public/admin/img/avatars/Sergey-Azovskiy.jpg" class="user-avatar">
                                                        ...
                                                        <li class="ticket-item">
                                                            <div class="row">
                                                                <div class="ticket-user col-lg-6 col-sm-12">
                                                                    <img src="/ypa/Public/admin/img/avatars/John-Smith.jpg" class="user-avatar">
    ...
    <!--Basic Scripts-->
    <script src="/ypa/Public/admin/js/jquery-2.0.3.min.js"></script>
    <script src="/ypa/Public/admin/js/bootstrap.min.js"></script>

    <!--Beyond Scripts-->
    <script src="/ypa/Public/admin/js/beyond.min.js"></script>


    <!--Page Related Scripts-->
    <!--Sparkline Charts Needed Scripts-->
    <script src="/ypa/Public/admin/js/charts/sparkline/jquery.sparkline.js"></script>
    <script src="/ypa/Public/admin/js/charts/sparkline/sparkline-init.js"></script>

    <!--Easy Pie Charts Needed Scripts-->
    <script src="/ypa/Public/admin/js/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="/ypa/Public/admin/js/charts/easypiechart/easypiechart-init.js"></script>

    <!--Flot Charts Needed Scripts-->
    <script src="/ypa/Public/admin/js/charts/flot/jquery.flot.js"></script>
    <script src="/ypa/Public/admin/js/charts/flot/jquery.flot.resize.js"></script>
    <script src="/ypa/Public/admin/js/charts/flot/jquery.flot.pie.js"></script>
    <script src="/ypa/Public/admin/js/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="/ypa/Public/admin/js/charts/flot/jquery.flot.orderBars.js"></script>
