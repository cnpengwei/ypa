...
<?php if(isset($e['file'])) {?>
	<div class="info">
		...
		<div class="text">        
            ...
            <p>FILE: <?php echo str_replace('/alidata1/www/www.youpiaoa.cn/','', $e['file']); ?> &#12288; LINE: <?php echo $e['line'];?> </p>
		</div>
	</div>
<?php }?>
<?php if(isset($e['trace'])) {?>
	<div class="info">
		...
		<div class="text">
            ...
            <p><?php echo nl2br(str_replace('/alidata1/www/www.youpiaoa.cn/','', $e['trace']));?></p>
		</div>
	</div>
<?php }?>
</div>
